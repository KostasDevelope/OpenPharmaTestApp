...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenPharmaTestApp.TasksList.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("OpenPharmaCustomers", (string)null);
                });

            modelBuilder.Entity("OpenPharmaTestApp.TasksList.CustomerTaskList", b =>
                {
                    ...
                    b.HasKey("CustomerId", "TaskListId");

                    b.HasIndex("TaskListId");

                    b.ToTable("OpenPharmaCustomerTaskLists", (string)null);
                });

            modelBuilder.Entity("OpenPharmaTestApp.TasksList.TaskList", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("OpenPharmaTaskLists", (string)null);
                });
            ...
            modelBuilder.Entity("OpenPharmaTestApp.TasksList.CustomerTaskList", b =>
                {
                    b.HasOne("OpenPharmaTestApp.TasksList.Customer", "Customer")
                        .WithMany("CustomerTaskLists")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OpenPharmaTestApp.TasksList.TaskList", "TaskList")
                        .WithMany("CustomerTaskLists")
            ...
            modelBuilder.Entity("OpenPharmaTestApp.TasksList.Customer", b =>
                {
                    b.Navigation("CustomerTaskLists");

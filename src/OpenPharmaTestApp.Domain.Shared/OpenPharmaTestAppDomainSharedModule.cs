...
public class OpenPharmaTestAppDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        OpenPharmaTestAppGlobalFeatureConfigurator.Configure();
        OpenPharmaTestAppModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<OpenPharmaTestAppDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<OpenPharmaTestAppResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/OpenPharmaTestApp");

            options.DefaultResourceType = typeof(OpenPharmaTestAppResource);
        ...
        {
            options.MapCodeNamespace("OpenPharmaTestApp", typeof(OpenPharmaTestAppResource));
        });
    }
}
